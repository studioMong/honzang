...
최종 제품 목표와 100% 완료 기준은 [혼자장부 최종 목표](docs/project-goal.md)에 고정합니다.
...
- 수기 거래 입력, 수정, 개별 삭제
- 거래 자동 분류 초안
- 사용자 자동 분류 규칙 추가, 수정, 사용/중지, 삭제
- 거래처별 기본 계정 추가, 수정, 삭제
- 계정과목 수동 확정
- 증빙 상태 관리
- 증빙-거래 추천 매칭
- 소형 증빙 파일 DB 보관 및 다운로드
- 증빙 메타데이터/파일 수정, 개별 삭제와 민감 데이터 보관/삭제 기준 확인
- 검토함 열린/완료/무시 필터
- 검토 항목 처리 상태 관리
...
- 법인 부가세 예정/확정, 원천세, 지급명세서/간이지급명세서, 법인세 신고 일정과 신고 준비 순서 안내
