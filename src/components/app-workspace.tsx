...
function downloadClosingSnapshotZip(fileName: string, payload: ReturnType<typeof buildClosingSnapshotExportPayload>) {
  downloadBlob(fileName, createZipBlob(buildClosingSnapshotZipFiles(payload)));
}
...
function downloadWorkspaceBackupArchive(
  ...
  downloadBlob(fileName, createZipBlob(buildWorkspaceBackupZipFiles(payload, evidences)));
}
